  ...
  return (
    ...
    <>
      ...
      <section className="hero column-center py-5 px-3">
        <h1 className="hero-title w-75 text-center fw-bold">Bienvenido a <strong>CineMagic</strong></h1>
        <p className="text-center max-w-[600px]">Vive la magia del cine con la mejor experiencia. Reserva tus películas favoritas, selecciona tus snacks y disfruta del mejor entretenimiento.</p>
        <article className="enlaces d-flex justify-center  w-100">
          <NavLink to={'/peliculas'} target="_self" className='border-none bg-[#f59f0a] fs-6'><i className="fa-solid fa-film"></i>Ver películas</NavLink>
          <NavLink to={'/snacks'} target="_self" className='fs-6' ><i className="fa-solid fa-cookie"></i>Snacks</NavLink>
        </article>
      </section>
      ...
      <section className="como-funciona py-5 px-3 bg-[#162034]">
        ...
        <section className="steps">
          ...
          <article className="step">
            <div className="icon"><i className="fa-solid fa-film"></i></div>
          ...
          <article className="step">
            <div className="icon"><i className="fa-solid fa-cookie-bite"></i></div>
      ...
      <section className="valoraciones">
        ...
        <h1 className="title py-5 fw-bold fs-4 text-center">Lo que dicen nuestros usuarios</h1>
          ...
          <section className="izq-der px-4 py-3">
            ...
            <article className="izquierda d-flex flex-row flex-wrap">
              ...
              <section className="motivo d-flex">
                ...
                <article className="icon"><i className="fa-solid fa-calendar"></i></article>

                <article className="texto">
                  <h3>Reserva anticipada</h3>
                  <p>Asegura tu lugar hasta con 30 días de anticipación. Nunca más te quedarás sin boletos.</p>
                </article>
            ...
            <article className="derecha d-flex flex-col p-4 bg-[#433029]">
              ...
              <p>Más de 50,000 usuarios ya disfrutan de la mejor experiencia cinematográfica. ¿Qué estás esperando?</p>
